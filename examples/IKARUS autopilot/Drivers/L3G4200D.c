...
void L3G4200D_Init(void){
	...
	//Reset
//	I2C_WrData(L3G4200D_ADDR_HIGH, L3G_CTRL_REG5,0x80);
	Delay(300);
	//Pen=Xen=Yen=Zen=1
	I2C_WrData(L3G4200D_ADDR_HIGH, L3G_CTRL_REG1, 0x0F);
//	I2C_WrData(L3G4200D_ADDR_HIGH, L3G_CTRL_REG1, 0xFF);
	
	Delay(300);
	//Full Scale
		I2C_WrData(L3G4200D_ADDR_HIGH, L3G_CTRL_REG4, 0xb0); //0x30
	
	Delay(300);
	
	//Filtro HPF
	I2C_WrData(L3G4200D_ADDR_HIGH, L3G_CTRL_REG2, 0x30);//0x20); //0x30
	//HPF EN
	I2C_WrData(L3G4200D_ADDR_HIGH, L3G_CTRL_REG5,0x10);

	
}

 Gyro_Data L3G4200D_Read(void){
	 Gyro_Data _gyro;
	 uint8_t _buff[6];
	 	
	 I2C_RdData(L3G4200D_ADDR_HIGH , L3G_OUT_X_L| 0x80, _buff, 6);
