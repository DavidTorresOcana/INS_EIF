...
global B_0
   ...
   H(7:9,1:3) = [ 0 ,[-st*cps,-st*sps,-ct]*B_0,[-ct*sps,ct*cps,0]*B_0;
                [cp*ct*cps+sp*sps,cp*st*sps-sp*cps,cp*ct]*B_0,[-sp*st*cps,sp*ct*sps,-sp*st]*B_0,[-sp*ct*sps-cp*cps,sp*st*cps-cp*sps,0]*B_0;
                [-sp*st*cps+cp*sps,-sp*st*sps-cp*cps,-sp*ct]*B_0,[cp*ct*cps,cp*ct*sps,-cp*st]*B_0,[-cp*st*sps+sp*cps,cp*st*cps+sp*sps,0]*B_0];
%     H(4:6,1:3) = g*[ 0 ,-ct,0;
%                     cp*ct,-sp*st,0;
%                     -sp*ct,-cp*st,0];
