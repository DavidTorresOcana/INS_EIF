...
%					avec tous les paramètres nulles
%
%	DEMARCHE	:	Tentative de reproduction du display BFGoodrich Aerospace
%					Cette routine sert uniquement à créer (dans l'ordre de couche d'affichage)
%					les objet du display qui seront ensuite modifiés par la simulation
%
...
set(gca,'Xtick',[])
set(gca,'Ytick',[])
set(gca,'Position',[0.05 0 0.77 1])	%Repère orthonormé et placé sur la feuille
...
set(Display.VitesseValue,'Fontsize',18)
